...
const TopPost = () => {
  ...
  return (
    <div>
      ...
      <div>
        <img src="https://domf5oio6qrcr.cloudfront.net/medialibrary/3440/conversions/w0714a16207251033667-thumb.jpg" alt="" height={"270px"} style={{borderRadius:"10px"}}/>
                ...
                {count.filter((item) => item.cat === 'foodtop').map((d, index) => {
                    return (
                        <div style={{display:"flex",flexWrap:"wrap", gap:"15px", marginTop:"25px"}}>
                          ...
                          <div>
                          <h5> Depending on age, sex, and<br /> consectetur adipisicing elit.</h5>
