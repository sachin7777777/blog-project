...
const TopPost = () => {
  ...
  return (
    <div>
      ...
      <div>
        <img src="https://7esl.com/wp-content/uploads/2018/03/sport-and-exercise.jpg" alt="" height={"270px"} style={{borderRadius:"10px"}}/>
                ...
                {count.filter((item) => item.cat === 'fitnesstop').map((d, index) => {
                    return (
                        <div style={{display:"flex",flexWrap:"wrap", gap:"15px", marginTop:"25px"}}>
                          ...
                          <div>
                          <h5> prohibitionist from Kansas<br /> consectetur adipisicing elit.</h5>
